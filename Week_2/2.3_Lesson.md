...
- **Layer 1 (Firewall)**: Bypassed via phishing email
- **Layer 2 (Network Monitoring)**: Failed to detect lateral movement quickly enough
- **Layer 3 (Endpoint Protection)**: Antivirus didn't catch new ransomware variant
- **Result**: 9.7 million customer records stolen, $100+ million in costs

**Lesson**: One defensive failure can expose entire network - need multiple layers.
